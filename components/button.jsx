...
export default function Button({
      ...
      const classes = clx(
            ...
            variant === 'contained' && category==="primary" && !disabled
            ...
            variant === 'contained' && category==="primary" && disabled
            && "cursor-not-allowed rounded-small bg-primary-500/50 dark:bg-secondary-100 dark:hover:bg-secondary-300 text-white dark:text-secondary-500 font-semibold",
            variant === 'outlined' && category==="primary" && !disabled
            ...
            variant === 'outlined' && category==="secondary" && !disabled
            ...
            variant === 'text' && category==="secondary" && !disabled
...
export function IconButton({
      ...
      const classes = clx(
            ...
            variant === 'outlined' && category==="secondary" && !disabled
            && "cursor-pointer rounded-small border-2 border-secondary-200 text-secondary-300 dark:text-secondary-200 font-semibold duration-500 hover:border-secondary-400 hover:text-secondary-500 focus:border-secondary-400 focus:text-secondary-500 active:bg-secondary-100 active:border-secondary-200",
            variant === 'outlined' && category==="secondary" && disabled
